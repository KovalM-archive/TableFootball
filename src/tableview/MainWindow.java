...
public class MainWindow {
    MainWindow() {
        ...
        JMenuItem jmiSearch = new JMenuItem("Search", KeyEvent.VK_R);
        jmiSearch.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, InputEvent.CTRL_MASK));
        JMenuItem jmiAddition = new JMenuItem("Addition", KeyEvent.VK_A);
        jmiAddition.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, InputEvent.CTRL_MASK));
        JMenuItem jmiDelete = new JMenuItem("Delete", KeyEvent.VK_D);
        ...
        jbtSearch.setActionCommand("Search");
        JButton jbtAddition = new JButton(imAddition);
        jbtAddition.setActionCommand("Addition");
